		...
		<div id="divOmOss">
			...
			<div id="innehallOmOss">
				...
				<p>
					...
					<p id="OBS">Avvikande får dessa regler kan få allvarliga konsekvenser. Då ingen kan vara anonym på vårat forum är du som person ansvarig för det som utförs som inloggad användare. </p>
